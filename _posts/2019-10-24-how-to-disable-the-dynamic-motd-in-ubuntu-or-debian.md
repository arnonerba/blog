...
If you'd rather work with `update-motd` than turn it off, detailed documentation for changing its output is available in the [man page for update-motd](https://manpages.ubuntu.com/manpages/bionic/en/man5/update-motd.5.html). Essentially, the dynamic MOTD is generated by a collection of executable scripts found in the `/etc/update-motd.d/` directory. These scripts can be updated, removed, or reordered, and new scripts can be added.
